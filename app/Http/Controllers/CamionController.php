...
class CamionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // intento de hacer la buscqueda
        // if($request){
        //     $query=trim($request->get('searchText'));
           
        //     $camion=DB::table('camiones')->where('dominio','%LIKE','%'.$query.'%')
        //         ->orderBy('id','desc')
        //         ->paginate(7);
        //    return view('abms.camiones.index',["camiones"=>$camion,"searchText"=>$query]);  
        
        // }

         $datos['camiones']=Camion::orderBy('dominio','ASC')->paginate(10);

        return view('abms.camiones.index',$datos);
