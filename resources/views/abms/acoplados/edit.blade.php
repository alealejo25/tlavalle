	...
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			...
			<div class="Form-group">
				...
				<input type="text" name="valor" class="form-control" value="{{$acoplados->valor}}">
			</div>
			<div class="Form-group">
			...
			<div class="Form-group">
				...
				@if($acoplados->id_camion===NULL)
					{!!Form::select('camion_id',$camiones,null,['class' => 'form-control','multiple','placeholder'=>'Seleccione una opcion','requerid' ])!!}
				@else
