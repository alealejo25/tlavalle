	...
	<div class="row">
		<div class="col-lg-6 col-lg-6 col-lg-6 col-xs-12">
			...
			<div class="Form-group">
				...
				<input type="email2" class="form-control {{$errors->has('email2')?'is-invalid':''}}" placeholder="Email..." name="email2" id="email2"  value="{{$proveedores->email2}}">
			...
			<div class="Form-group">
				...
				<input type="email3" class="form-control {{$errors->has('email3')?'is-invalid':''}}" placeholder="Email..." name="email3" id="email3"  value="{{$proveedores->email3}}">
